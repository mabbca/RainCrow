...
export function parseWeather(times, weatherResults, parsedWeather) {
  ...
  parsedWeather.windspeed.mph = `Wind: ${dataRange(Math.round(windspeed.start.avg), Math.round(windspeed.end.avg))}mph`;
  ...
  parsedWeather.windspeed.beaufort = `Beaufort force: ${dataRange(Math.round(mphToBeaufort(windspeed.start.avg)), Math.round(mphToBeaufort(windspeed.end.avg)))}`;
